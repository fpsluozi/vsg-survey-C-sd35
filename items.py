"""Build the 26 survey pages (13 prompts x base/Gemma4 condition) for the sd35 model.
...
Images: survey_images/sd35_base/<id>.png and survey_images/sd35_gemma/<id>.png.
